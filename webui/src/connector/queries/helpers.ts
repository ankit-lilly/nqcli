...
/** Resolves the framework-independent application services for a query. */
export function getConnectionApplication(meta: GraphExplorerMeta | undefined) {
	return createConnectionApplication(getExplorer(meta));
}
