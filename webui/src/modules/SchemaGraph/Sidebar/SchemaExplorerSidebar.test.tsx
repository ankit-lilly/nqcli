...
describe("SchemaExplorerSidebar", () => {
	test("shows all schema node labels and relationships in the schema tab", () => {
		...
		expect(screen.getByText("Airport to City")).toBeInTheDocument();
	});
	...
	test("shows schema, details, and styles sidebar tabs", () => {
